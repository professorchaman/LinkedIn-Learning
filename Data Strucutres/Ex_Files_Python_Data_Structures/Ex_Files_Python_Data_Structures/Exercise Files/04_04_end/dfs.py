...
if __name__ == "__main__":
    ...
    # Test 2
    maze = read_maze(file_name="Personal_Files\LinkedIn\Ex_Files_Python_Data_Structures\Ex_Files_Python_Data_Structures\Exercise Files\04_04_end\mazes\mini_maze_dfs.txt")
    #print(maze)
