...
def bfs(maze, start, goal):
    ...
    while not queue.is_empty():
        ...
        for direction in ["up", "right", "down", "left"]:
            ...
            negihbour = (current_cell[0]+row_offset,current_cell[1]+col_offset)
            
            if is_legal_pos(maze, negihbour) and negihbour not in predecessors:
                queue.enqueue(negihbour)
                predecessors[negihbour] = current_cell
